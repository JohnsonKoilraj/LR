...
Revision ID: 19f316eb6a2b
Revises: cb40577d6954
Create Date: 2023-11-06 15:55:50.867484
...
revision: str = '19f316eb6a2b'
down_revision: Union[str, None] = 'cb40577d6954'
...
def upgrade() -> None:
    ...
    sa.Column('consignor_name', sa.String(length=50), nullable=True),
    sa.Column('consignor_mobile_no', sa.String(length=50), nullable=True),
    sa.Column('consignor_address', sa.String(length=250), nullable=True),
    sa.Column('consignor_gst', sa.String(length=50), nullable=True),
    sa.Column('consignee_name', sa.String(length=50), nullable=True),
    sa.Column('consignee_mobile_no', sa.String(length=50), nullable=True),
    sa.Column('consignee_address', sa.String(length=250), nullable=True),
